...
public class AddMood extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        keterangan = (EditText) findViewById(R.id.txt_keterangan);
        ...
        btAddData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                RequestBody reqketerangan = MultipartBody.create(MediaType.parse("multipart/form-data"),
                        (keterangan.getText().toString().isEmpty())?"":keterangan.getText().toString());
                RequestBody reqAction = MultipartBody.create(MediaType.parse("multipart/form-data"),
                        "insert");
                Call<GetMood> moodCall = mApiInterface.postMood(body,reqketerangan, reqAction);
